    ...
    def __init__(self):
        ...
        self.rules = {
            "person": {
                ...
                "organization": {"action": "delete", "patterns": org_patterns},
            },
            "organization": {
                "name": {
                    "action": "invalidate",
...
if __name__ == "__main__":
    test_records = [
        ...
        {"type": "person", "full_name": "GGGG"},
        {
            "type": "person",
            "full_name": "Some Person",
            "organization": "NCEAS: 50020 This is a working group org.",
        },
        {"type": "person", "full_name": "You and your mentor"},
        {"type": "organization", "name": ""},
        {"type": "organization", "name": "NCEAS: 50020 This is a working group org."},
    ]
