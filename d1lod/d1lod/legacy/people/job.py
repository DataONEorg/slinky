...
class Job:
    def __init__(self, directory):
        ...
        # Create writers
        self.people_writer = unicodecsv.writer(
            self.people_file_handle, encoding="utf-8"
        )
        self.organization_writer = unicodecsv.writer(
            self.organizations_file_handle, encoding="utf-8"
        )
