...
def test_processor_extracts_top_metadata(client, model):
    ...
    statement = RDF.Statement(
        ...
        RDF.Node(
            "Gut Fluorescence measurements of mesozooplankton grazing on autotrophic prey. "
    ...
    statement = RDF.Statement(
        ...
        RDF.Node(
            "Mesozooplankton are collected with plankton nets (typically a 71-cm diameter, 202-um mesh Bongo net)"
